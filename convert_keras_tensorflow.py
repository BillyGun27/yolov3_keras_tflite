...
pb_filename = 'tiny_yolo_model.pb'
#model  = load_model('model_data/small_mobilenet_trained_model.h5')
#model  = load_model('model_data/mobilenetv2_trained_model.h5')
model  = load_model('model_data/tiny_yolo_model.h5')
...
with tf.Session() as sess:
    ...
    tensor_output = sess.graph.get_tensor_by_name('import/conv2d_5/Conv2D:0')
